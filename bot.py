...
def shop(message):
    ...
    if not prices:
        ...
        return
    text = "Raqamlar narxlari:\n\n"
    for davlat, narx in prices.items():
        text += f"{davlat}: {narx} so'm\n"
